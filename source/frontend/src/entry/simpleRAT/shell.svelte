...
<style>
  ...
  :global(.xterm.focus, .xterm:focus) {
    outline: none;
  }
  ...
  :global(.xterm.xterm-cursor-pointer, .xterm .xterm-cursor-pointer) {
    cursor: pointer;
  }
  ...
  :global(.xterm .xterm-accessibility, .xterm .xterm-message) {
    position: absolute;
    left: 0;
    top: 0;
    bottom: 0;
  ...
  :global(.xterm-underline-1) {
    text-decoration: underline;
  }
  :global(.xterm-underline-2) {
    text-decoration: double underline;
  }
  :global(.xterm-underline-3) {
    text-decoration: wavy underline;
  }
  :global(.xterm-underline-4) {
