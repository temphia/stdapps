<div
  class="mb-4 w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 p-2"
>
  <div
  ...
  <div class="bg-white rounded-b-lg dark:bg-gray-800">
    <textarea
      id="editor"
      class="block px-0 w-full h-full text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"
